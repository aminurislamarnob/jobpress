                ...
                <div class="jp-form-row">
                    <div class="jp-form-half">
                        <div class="jp-form-group">
                            ...
                            <input type="text" class="jp-form-control" id="applyName" placeholder="Full name">
                        </div>
                    </div>
                    <div class="jp-form-half">
                        <div class="jp-form-group">
                            <label for="applyEmail"><?php esc_html_e( 'Email address', 'jobpress' ); ?></label>
                            <input type="text" class="jp-form-control" id="applyEmail" placeholder="hello@domain.com">
                        </div>
                    </div>
                </div>
                <div class="jp-form-group mb-5">
                    <p class="mb-2"><?php esc_html_e( 'Resume', 'jobpress' ); ?></p>
                    <div class="jp-custom-file">
                        <input type="file" class="jp-custom-file-input" id="applyResume">
                        <label class="jp-custom-file-label" for="applyResume"><?php esc_html_e( 'Choose file', 'jobpress' ); ?></label>
                    </div>
                </div>
                <div class="jp-form-group">
                    <label for="applyMessage"></label>
                    <textarea id="applyMessage" rows="5" class="jp-form-control" placeholder="Let us know!"></textarea>
                </div>
                <div class="jp-form-row jp-align-items-center jp-justify-between">
                    <div class="jp-form-half">
                        <button class="jp-btn jp-submit-btn jp-mt-0"><?php esc_html_e( 'Apply Now', 'jobpress' ); ?></button>
                    </div>
                    <div class="jp-form-half">
